...
export const RPC_REQUIRED_SCOPES = {
  ...
  [WS_METHODS.promptStashSubscribe]: AuthOrchestrationReadScope,
  [WS_METHODS.promptStashGet]: AuthOrchestrationReadScope,
  [WS_METHODS.promptStashSave]: AuthOrchestrationOperateScope,
  [WS_METHODS.promptStashDelete]: AuthOrchestrationOperateScope,
