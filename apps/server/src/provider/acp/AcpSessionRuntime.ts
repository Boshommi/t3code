  ...
  Effect.gen(function* () {
    ...
    const startOnce = Effect.gen(function* () {
      ...
      if (options.resumeSessionId && options.resumeMethod === "resume") {
        ...
        sessionSetupResult = yield* loadExistingSession(initializeResult, resumeSessionId).pipe(
          Effect.catch((error) =>
        ...
        const resolved = sessionIdFromSetup(sessionSetupResult) ?? resumeSessionId;
