...
contextBridge.exposeInMainWorld("desktopBridge", {
  ...
  setWindowMaterial: (material) =>
    ipcRenderer.invoke(IpcChannels.SET_WINDOW_MATERIAL_CHANNEL, material),
  ...
  preview: {
    ...
    onGuestPointerDown: (listener) => {
      ...
      ipcRenderer.on(IpcChannels.PREVIEW_GUEST_POINTER_DOWN_CHANNEL, wrappedListener);
      return () =>
        ipcRenderer.removeListener(IpcChannels.PREVIEW_GUEST_POINTER_DOWN_CHANNEL, wrappedListener);
    },
  },
