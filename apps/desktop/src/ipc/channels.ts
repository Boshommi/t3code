...
export const SET_WINDOW_MATERIAL_CHANNEL = "desktop:set-window-material";
...
export const PREVIEW_FORWARD_PORT_CHANNEL = "desktop:preview-forward-port";
export const PREVIEW_STOP_PORT_FORWARD_CHANNEL = "desktop:preview-stop-port-forward";
export const PREVIEW_LIST_PORT_FORWARDS_CHANNEL = "desktop:preview-list-port-forwards";
