    ...
    <SettingsPageContainer>
      <SettingsSection title="General">
        ...
        <SettingsRow
          ...
          description="Pick the default workspace mode for newly created draft threads. The same Current checkout / New worktree control in the workspace picker saves this default."
          resetAction={
            settings.defaultThreadEnvMode !== DEFAULT_UNIFIED_SETTINGS.defaultThreadEnvMode ||
            settings.newWorktreesStartFromOrigin !==
              DEFAULT_UNIFIED_SETTINGS.newWorktreesStartFromOrigin ? (
        ...
        {settings.defaultThreadEnvMode === "worktree" ? (
          <SettingsRow
            ...
            description="Creates the worktree from the latest matching branch on origin instead of your local branch. The same switch in the branch picker saves this default."
            resetAction={
              settings.newWorktreesStartFromOrigin !==
              DEFAULT_UNIFIED_SETTINGS.newWorktreesStartFromOrigin ? (
                <SettingResetButton
