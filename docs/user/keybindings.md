...
toolbar. **Current checkout** / **New worktree** and **Start from origin** in the workspace
picker are the same defaults as **Settings → General → New threads**, and flipping them is
remembered after reload. The only
